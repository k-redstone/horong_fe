...
export const INBOX_CONSTANT: InboxConstantType = {
  KOREAN: {
    ...
    'notify-new-comment-txt': '글에 새 댓글이 달렸습니다.',
    'notify-new-message-txt': '새 쪽지가 도착했습니다.',
  },
  ...
  ENGLISH: {
    ...
    'notify-new-comment-txt': 'A new comment has been posted.',
    'notify-new-message-txt': 'You have a new message.',
  },
  ...
  CHINESE: {
    ...
    'notify-new-comment-txt': '有新评论。',
    'notify-new-message-txt': '您有一条新消息。',
  },
  ...
  JAPANESE: {
    ...
    'notify-new-comment-txt': '新しいコメントが投稿されました。',
    'notify-new-message-txt': '新しいメッセージが届きました。',
  },
}
